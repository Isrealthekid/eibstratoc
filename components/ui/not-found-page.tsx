  ...
  return (
    ...
    >
      <motion.div
        ...
        transition={shouldReduceMotion ? { duration: 0 } : { duration: 2, ease: "easeInOut", repeat: Number.POSITIVE_INFINITY }}
      ...
      <Link
        href={homeHref}
        className={cn("mt-4 inline-flex items-center rounded-md bg-primary px-4 py-2 font-medium text-primary-foreground text-sm transition-colors hover:bg-primary/90 motion-reduce:transition-none", buttonClassName)}
      >
